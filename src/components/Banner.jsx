...
import banner from "../assets/whatsApp image 2025-11-26 at 2.50.37 AM.jpeg";
        ...
        >
            ...
            <div className="lg:w-3/5 text-center lg:text-left ">
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">
                    Hello, I'm <span className="text-lime-400">Ratul Hasan</span>
                </h1>
                ...
                <div className="flex gap-4 justify-center lg:justify-start mb-6">
                    <a
                        href="https://github.com/mdratul4505"
                        target="_blank"
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                    ...
                    <a
                        href="https://drive.google.com/file/d/1xHluO5cxJJOclcXD1X4YEOnExkMQFOgw/view?usp=sharing"
                        target="_blank"
