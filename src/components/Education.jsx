      ...
      >
        ...
        <div className="space-y-3 text-gray-300 text-xs sm:text-sm md:text-base sm:pl-9">
          ...
          <p>
            ...
            <strong>EIIN No:</strong> 833133
          </p>
          <p className="pt-3">
            <span className="text-lime-400 font-semibold">Core Skills Learned:</span><br />
             Java, Data Structure & Algorithm, DBMS, Networking, Computer Architecture, Business Communication, Web Development ( javascript), and more.
          </p>
        </div>
      </motion.div>
    </section>
