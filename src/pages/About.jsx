...
import { FaCoffee, FaFootballBall, FaMusic, FaPlaneDeparture } from "react-icons/fa";

import { motion } from "framer-motion";
import { NavigateContext } from "../context/NavigateProvider";
import aboutImg from "../assets/whatsApp image 2025-11-26 at 2.50.37 AM.jpeg";
      ...
      >
        ...
        <div className="text-white w-full max-w-3xl space-y-6">
          ...
          <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed text-justify">
            Hello! I'm <span className="font-semibold text-lime-400">Ratul Hasan</span>, a dedicated and results-driven MERN Stack Developer with a passion for building modern web apps. I specialize in technologies like <span className="text-lime-400 font-semibold">React.js, Node.js, MongoDB, Express.js</span>, and <span className="text-lime-400 font-semibold">Tailwind CSS</span>.
            <br /><br />
          ...
          <div className="text-gray-400 text-sm sm:text-base space-y-1 pt-2">
            <p><span className="text-lime-400 font-medium">Name:</span> Ratul Hasan</p>
            <p><span className="text-lime-400 font-medium">Nationality:</span> Bangladeshi</p>
            <p><span className="text-lime-400 font-medium">Address:</span> Chuadanga, khulna, Bangladesh</p>
            <p><span className="text-lime-400 font-medium">Phone:</span> +8801985435655</p>
            <p><span className="text-lime-400 font-medium">E-mail:</span> dev.ratul.coder@gmail.com</p>
