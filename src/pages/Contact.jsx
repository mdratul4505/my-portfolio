      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        >
          ...
          <div className="text-gray-300 space-y-2 text-sm sm:text-base">
            <p><strong>Email:</strong> dev.ratul.coder@gmail.com</p>
            <p><strong>WhatsApp:</strong> +880 1985-435655</p>
          </div>

          <div className="flex flex-wrap gap-4 pt-4 text-xl">
            <a href="https://github.com/mdratul4505" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-lime-400 transition sm:hover:scale-110">
              <FaGithub />
            </a>
            <a href="https://www.facebook.com/cadet.ratul.2024" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-lime-400 transition sm:hover:scale-110">
              <FaFacebook />
            </a>
            <a href="https://www.linkedin.com/in/mdratul-hasan/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-lime-400 transition sm:hover:scale-110">
              <FaLinkedin />
            </a>
            <a href="https://wa.me/8801985435655" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-lime-400 transition sm:hover:scale-110">
              <FaWhatsapp />
            </a>
          </div>
        </motion.div>
